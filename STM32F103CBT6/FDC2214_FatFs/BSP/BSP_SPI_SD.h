#ifndef __BSP_SPI_SD_H__
#define __BSP_SPI_SD_H__
...
#define LL_GPIO  1  //LL库
#define HAL_GPIO 0 //HAL库
#if HAL_GPIO
#define	SD_CS_Enable  			    HAL_GPIO_WritePin(GPIOB,SD_CS_Pin, GPIO_PIN_RESET) 	  
#define	SD_CS_Disable  			   HAL_GPIO_WritePin(GPIOB,SD_CS_Pin, GPIO_PIN_SET)
#endif

#if LL_GPIO
#define	SD_CS_Enable  			    LL_GPIO_ResetOutputPin(GPIOB,SD_CS_Pin) 	  
#define	SD_CS_Disable  			   LL_GPIO_SetOutputPin(GPIOB,SD_CS_Pin)
#endif
