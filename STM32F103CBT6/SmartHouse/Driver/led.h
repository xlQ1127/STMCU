...
#define  LED_RED_ON       GPIO_SetBits(GPIOB,GPIO_Pin_9)
#define  LED_GREEN_ON     GPIO_SetBits(GPIOB,GPIO_Pin_8)
#define  LED_YELLOW_ON    GPIO_SetBits(GPIOB,GPIO_Pin_7)
#define  LED_BLUE_ON      GPIO_SetBits(GPIOB,GPIO_Pin_6)

#define  LED_RED_OFF        GPIO_ResetBits(GPIOB,GPIO_Pin_9)
#define  LED_GREEN_OFF      GPIO_ResetBits(GPIOB,GPIO_Pin_8)
#define  LED_YELLOW_OFF     GPIO_ResetBits(GPIOB,GPIO_Pin_7)
