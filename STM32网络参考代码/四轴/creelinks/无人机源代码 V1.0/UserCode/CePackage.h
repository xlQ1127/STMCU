...
#define CE_FILTER_IN_YIJIEHUBU  0x00000001          /*!< 是否使用一阶互补滤波器*/
#define CE_FILTER_IN_ERJIEHUBU  0x00000002          /*!< 是否使用二阶互补滤波器*/
#define CE_FILTER_IN_IMU        0x00000004          /*!< 是否使用四元数+互补滤波器*/
#define CE_FILTER_IN_KALMAN     0x00000008          /*!< 是否使用卡尔曼滤波器*/
#define CE_FILTER_IN_DEBUG      0x00000010          /*!< 是否处于滤波器参数调整模式下*/

#define CE_PID_IN_DEBUG         0x00000020          /*!< 是否处于PID参数调整之下*/
#define CE_FILTER_IN_ANGLE_ZERO 0x00008000          /*!< 是否处于姿态零点调整模式下*/

#define CE_CTL_BTN_LEFT         0x00000040          /*!< 控制器左摇杆按钮*/
#define CE_CTL_BTN_RIGHT        0x00000080          /*!< 控制器摇杆右按钮*/
#define CE_CTL_BTN_S2A          0x00000100          /*!< 按钮器按钮S2A*/
#define CE_CTL_BTN_S2B          0x00000200          /*!< 按钮器按钮S2B*/
#define CE_CTL_BTN_S2C          0x00000400          /*!< 按钮器按钮S2C*/
#define CE_CTL_BTN_S2D          0x00000800          /*!< 按钮器按钮S2D*/
#define CE_CTL_TYPE_STATION     0x00001000          /*!< 无人机的受控方式：地面站点*/
#define CE_CTL_TYPE_CTL         0x00002000          /*!< 无人机的受控方式：遥控器*/
#define CE_CTL_TYPE_PHONE       0x00004000          /*!< 无人机的受控方式：手机*/
...
typedef struct
{
    ...
    uint8*      (*dealSend)(CePackageSend* cePackageSend, uint32 ctlStatus); /*!< 
