...
void WriteCmd(unsigned char I2C_Command) //Ð´ÃüÁî
{
	uint8_t *pData;
	pData = &I2C_Command;
	if (HAL_I2C_Mem_Write(&hOLED, 0x78, 0x00, I2C_MEMADD_SIZE_8BIT, pData, 1, 0xFFFF) != HAL_OK)
	{
		printf("I2C Err\r\n");
	}
}
...
void WriteDat(unsigned char I2C_Data) //Ð´Êý¾Ý
{
	...
	if (HAL_I2C_Mem_Write(&hOLED, 0x78, 0x40, I2C_MEMADD_SIZE_8BIT, pData, 1, 0xFFFF) != HAL_OK)
	{
		printf("I2C Err\r\n");
	}
}
