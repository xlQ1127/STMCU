...
#define FLASH_DESC_STR      "@Internal Flash   /0x08004000/16*01Ka,48*01Kg"
...
uint16_t MEM_If_Erase_FS(uint32_t Add)
{
  ...
  uint32_t PageError = 0;
 	FLASH_EraseInitTypeDef flash;
			...
			flash.PageAddress = USBD_DFU_APP_DEFAULT_ADD;
			flash.NbPages = (0x8010000-USBD_DFU_APP_DEFAULT_ADD)/FLASH_PAGE_SIZE;
