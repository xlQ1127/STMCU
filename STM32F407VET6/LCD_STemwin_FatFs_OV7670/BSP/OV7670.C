...
static void I2C_Write(uint8_t Addr, uint8_t Reg, uint8_t Value)
{
	...
	status = HAL_I2C_Mem_Write(&hSCCB, Addr, (uint16_t)Reg, I2C_MEMADD_SIZE_8BIT, &Value, 1, 0xFFFF);
...
static uint8_t I2C_Read(uint8_t Addr, uint8_t Reg)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint8_t Value = 0;
  status = HAL_I2C_Mem_Read(&hSCCB, Addr, Reg, I2C_MEMADD_SIZE_8BIT, &Value, 1, 0xFF);
  if(status != HAL_OK)
  {
...
uint8_t OV7670_Init(void)
{
	...
	else
	{
		...
		OV7670_Config();
		OV7670_Set_window(184 + 160*2, 10 + 120*2, 160, 120);
	}
	return 1;
}
