...
extern unsigned char  TxBuf[24];	  
extern unsigned char  RxBuf[24];

extern unsigned int   NRFTX[10];	  
extern unsigned int   NRFRX[10];

extern unsigned char  RX_times;
extern unsigned char  TX_times;
...
void NRF_TxPacket_AP(unsigned char * tx_buf, unsigned char len);
