...
/* 类型定义 ------------------------------------------------------------------*/
/* 宏定义 --------------------------------------------------------------------*/
#define NRF24L01_SPI_CS_ENABLE()                      LL_GPIO_ResetOutputPin(NRF_CSN_GPIO_Port, NRF_CSN_Pin)
#define NRF24L01_SPI_CS_DISABLE()                     LL_GPIO_SetOutputPin(NRF_CSN_GPIO_Port, NRF_CSN_Pin)
                                             


#define NRF24L01_CE_LOW()                              LL_GPIO_ResetOutputPin(NRF_CE_GPIO_Port, NRF_CE_Pin);
#define NRF24L01_CE_HIGH()                             LL_GPIO_SetOutputPin(NRF_CE_GPIO_Port, NRF_CE_Pin);


#define NRF24L01_IRQ_PIN_READ()                        LL_GPIO_IsInputPinSet(NRF_IRQ_GPIO_Port,NRF_IRQ_Pin)
