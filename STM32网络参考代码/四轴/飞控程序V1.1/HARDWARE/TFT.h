...
/////////////////////TFT_LCD背光 PC10/////////////////////
#define LCD_LED(a) if(a) GPIO_SetBits(GPIOC,GPIO_Pin_10);\
...
void LCD_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2);//画长方形		   
void LCD_Fill(u16 xsta,u16 ysta,u16 xend,u16 yend,u16 color);//颜色填充函数

void LCD_ShowChar(u16 x,u16 y,u8 num,u8 size,u8 mode);//显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode); //显示正整数
void LCD_ShowString(u16 x,u16 y,const u8 *p,u8 mode);//显示字符串,16字体
void LCD_ShowFloatNum(u16 x,u16 y,float num,u8 nu_n,u8 fl_n,u8 size,u8 mode);//显示正小数
