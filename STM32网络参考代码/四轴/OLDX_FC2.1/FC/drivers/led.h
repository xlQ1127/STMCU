...
#define LED1_OFF1         //GPIOA->BSRRL = GPIO_Pin_5   //H
#define LED1_ON1          //GPIOA->BSRRH = GPIO_Pin_5		//L
#define LED2_ON1          GPIOC->BSRRL = GPIO_Pin_7
#define LED2_OFF1         GPIOC->BSRRH = GPIO_Pin_7
#define LED3_ON1          GPIOA->BSRRL = GPIO_Pin_5
#define LED3_OFF1         GPIOA->BSRRH = GPIO_Pin_5
#define LED4_ON1          GPIOA->BSRRL = GPIO_Pin_6
#define LED4_OFF1         GPIOA->BSRRH = GPIO_Pin_6
