...
/* 类型定义 ------------------------------------------------------------------*/
/* 宏定义 --------------------------------------------------------------------*/
#define NRF24L01_SPI_CS_ENABLE() HAL_GPIO_WritePin(GPIOB, NRF_CSN_Pin, GPIO_PIN_RESET)
#define NRF24L01_SPI_CS_DISABLE() HAL_GPIO_WritePin(GPIOB, NRF_CSN_Pin, GPIO_PIN_SET)

#define NRF24L01_CE_LOW() HAL_GPIO_WritePin(GPIOB, NRF_CE_Pin, GPIO_PIN_RESET)
#define NRF24L01_CE_HIGH() HAL_GPIO_WritePin(GPIOB, NRF_CE_Pin, GPIO_PIN_SET)
...
void NRF24L01_RxPacket(uint8_t *rxbuf);                                   //接收一个包的数据
