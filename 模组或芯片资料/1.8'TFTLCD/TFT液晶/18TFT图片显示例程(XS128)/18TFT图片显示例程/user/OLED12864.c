...
//==============================================================
//函数名：LCD_P6x8Strprintf_number(byte x,byte y,int data)
//功能描述：写入一组标准数字或变量
//参数：显示的位置（x,y），y为页范围0～7，要显示的字符串
//返回：无
//==============================================================  
...
void oled(void)
{
  ...
  ch[0] = (byte)(t/10000)+'0';
  ch[1] = (byte)(t/1000%10)+'0'; 
  ch[2] = (byte)(t/100%100)+'0';
  ch[3] = (byte)(t%100/10)+'0';
  ch[4] = (byte)(t%10)+'0';
  ch[5] = '\0';
...
void oledt1(byte x,byte y,int t)
{
   ...
   // ch[0] = (byte)(t/10000)+'0';
    ch[0] = (byte)(t/1000)+'0'; 
    ch[1] = (byte)(t/100%10)+'0';
    ch[2] = (byte)(t%100/10)+'0';
    ch[3] = (byte)(t%10)+'0';
    ch[4] = '\0';
...
void oledt2(byte x,byte y,int t)
{
   ...
   // ch[0] = (byte)(t/10000)+'0';
   // ch[0] = (byte)(t/1000%10)+'0'; 
   // ch[1] = (byte)(t/100%100)+'0';
   // ch[2] = (byte)(t%100/10)+'0';
    ch[0] = (byte)(t%10)+'0';
    ch[1] = '\0';
